            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    zariadenieID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nazov = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Spotreba = table.Column<float>(type: "real", nullable: false),
                    Dlzka = table.Column<float>(type: "real", nullable: false),
                    UserID = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    connectedID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Spotreba = table.Column<int>(type: "int", nullable: false),
                    Spustene = table.Column<bool>(type: "bit", nullable: false),
                    ParentID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_connected", x => x.connectedID);
                    table.ForeignKey(
                        name: "FK_connected_controller_ParentID",
                        column: x => x.ParentID,
